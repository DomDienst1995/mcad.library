...
/**
  ...
  * myStepStamp = someScheduler.createStepStamp(1,3,0); // 2nd bar, 4th beat, 1st step, patternPos = 12, guid = 28
*/
...
function Scheduler(context, options) {
	...
	/**
	  ...
	  * var scheduler = Scheduler(audioCtx, {onQueue: playNote}); 
	  *
	  ...
	  * var scheduler = Scheduler(audioCtx, {onAnim: animateNote}); 
	  *
	  ...
	  * var scheduler = Scheduler(audioCtx, {onTween: tweenNote}); 
	  *
...
/** 
  ...
  * someScheduler.start(someStepStamp);
  */
...
/** 
  ...
  * someScheduler.offsetStepStamp(myStepStamp, -12);
  * @example <caption>Offset a step position stamp by 3 steps forwards</caption>
  * someScheduler.offsetStepStamp(myStepStamp, 3);
  */
